...
if "%ADDRESS%"=="" (
	...
	call adb %S_DEVICE% shell am start -a com.sensoro.android.action.DFU_UPLOAD^
 -e no.nordicsemi.android.extra.dfu.EXTRA_FILE_PATH "/sdcard/Nordic Semiconductor/%HEX_FILE%" | find "unable" > nul 2>&1
	...
	call adb %S_DEVICE% shell am startservice -a com.sensoro.android.action.DFU_UPLOAD^
